    ...
    productItems.forEach(item => {
        ...
        if (item.dataset.productName) {
            item.addEventListener('click', function () {
                ...
                if (currentProduct.type === 'PicsArt Gold') {
                    modalProductLogo.src =
                        "../assets/image/logo/apk/picsart.jpg";
                }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const packageInfo = {
        "PICSART LIST": {
            "title": "PICSART GOLD",
            "description": "I Akun Seller<br>I 1000% Legal<br>I Bisa IOS / Android<br>I Full Garansi selama event msh ada<br>I Private 1 Bulan"
        }
    };
