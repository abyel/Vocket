    ...
    productItems.forEach(item => {
        ...
        if (item.dataset.productName) {
            item.addEventListener('click', function () {
                ...
                if (currentProduct.type === 'BSTATION') {
                    modalProductLogo.src =
                        "../assets/image/logo/apk/bstation.jpg";
                }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const packageInfo = {
        "BSTATION LIST": {    
             "title": "SHARING",    
            "description": "I Akun store<br>I Tidak bisa ganti email dan password<br>I Bisa langganan ulang jika masa aktif habis"
        }
    };
