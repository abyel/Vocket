    ...
    productItems.forEach(item => {
        ...
        if (item.dataset.productName) {
            item.addEventListener('click', function () {
                ...
                if (currentProduct.type === 'WeTV') {
                    modalProductLogo.src =
                        "../assets/image/logo/apk/wetv.webp";
                }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const packageInfo = {
        "WETV SHARING": {
            "title": "WETV SHARING (6U)",
            "description": "<b>NOTE :</b><br>I Akun WeTV Premium berbagi dengan 6 user<br>I Full durasi 3 bulan tanpa pindah akun<br>I Tidak bisa ganti email dan password<br>I Bisa langganan ulang jika masa aktif habis"
        },
        "WETV SHARING ANTI LIMIT": {
            "title": "WETV SHARING ANTI LIMIT (3U)",
            "description": "<b>NOTE :</b><br>I Akun WeTV Premium berbagi dengan 3 user<br>I Full durasi 3 bulan tanpa pindah akun<br>I Tidak bisa ganti email dan password<br>I Bisa langganan ulang jika masa aktif habis"
        },
        "WETV PRIVATE": {
            "title": "WETV PRIVATE",
            "description": "<b>NOTE :</b><br>I Akun WeTV Premium yang digunakan sendiri (private)<br>I Akun store<br>I Only login 1 device (sharing)<br>I Full garansi<br>I Tidak bisa ganti email dan password<br>I Bisa langganan ulang jika masa aktif habis"
        }
    };
