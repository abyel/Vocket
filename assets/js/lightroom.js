    ...
    productItems.forEach(item => {
        ...
        if (item.dataset.productName) {
            item.addEventListener('click', function () {
                ...
                if (currentProduct.type === 'Lightroom Premium') {
                    modalProductLogo.src =
                        "../assets/image/logo/apk/lightroom.jpg";
                }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const packageInfo = {
        "LIGHTROOM LIST": {
            "title": "LIGHTROOM PREMIUM SHARING",
            "description": "<b>NOTE :</b><br>I Akun Sharing dari seller<br>I Support IOS dan ANDROID<br>I Tanyakan Stok Dahulu<br>I Garansi 6 Bulan, Garansi selama method masih ada<br>I Tidak bisa ganti email dan password<br>I Bisa langganan ulang jika masa aktif habis"
        }
    };
