    ...
    productItems.forEach(item => {
        ...
        if (item.dataset.productName) {
            item.addEventListener('click', function () {
                ...
                if (currentProduct.type === 'Alight Motion') {
                    modalProductLogo.src =
                        "../assets/image/logo/apk/alightmotion.jpg";
                }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const packageInfo = {
        "ALIGHT MOTION LIST": {
            ...
            "description": "| Private<br>| Garansi 6 Bulan, Garansi selama method masih ada<br>| Tidak bisa ganti email dan password<br>| Bisa langganan ulang jika masa aktif habis"
        },
