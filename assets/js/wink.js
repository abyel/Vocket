    ...
    productItems.forEach(item => {
        ...
        if (item.dataset.productName) {
            item.addEventListener('click', function () {
                ...
                if (currentProduct.type === 'Wink') {
                    modalProductLogo.src =
                        "../assets/image/logo/apk/wink.webp";
                }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const packageInfo = {
        "WINK LIST": {
            "title": "WINK SHARING",
            "description": "I Akun dari seller<br>I 1 tahun garansi 6 bulan<br>I Login via email<br>I Tidak bisa ganti email dan password<br>I Bisa langganan ulang jika masa aktif habis"
        }
    };
